...
//			
                        $abr_file="";
            switch ($_GET['type_adj']) {
                case 1:
                    $abr_file="acta_name";
                    break;
                case 2:
                    $abr_file="acta_representante";
                    break;
                case 3:
                    $abr_file="id_representante";
                    break;
                case 4:
                    $abr_file="res_judicial";
                    break;
                case 5:
                    $abr_file="acta_persona";
                    break;
                case 6:
                    $abr_file="iden_tutela";
                    break;
                case 7:
                    $abr_file="aprob_jud";
                    break;
...
//                                print_r($classent);die();                                        
					...
					$nombre    =$abr_file.$classent->$imagen_file;
					$path    = $classent->$path;
//                                        echo 'asdas<pre>';
//                                        print_r($classent);
//                                       die($path."  ----  ".$nombre);
