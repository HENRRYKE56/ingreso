...
$a_table=array();
$a_table['unidad_usuario']=array('unidad u');
$a_lbl=array();
$a_lbl['equipo']='';
$field=array();
	$field[]=array('desuni','unidad','1','label','1','','char','','u',20,0,'',0,0,0,'','',1,1,1);	
...
foreach ($a_table[$_POST['entvalue']] as $tableItem){
	$sqlQry= $sqlQryFields.$sqlQryFrom . ' ' . $tableItem  .$sqlQryWhere. $strCondConsul . $sqlQryOrder;
...
////////////////////////////////////////////////
$a_table=array();
$a_table['unidad_usuario']=array('conf_disp cd');
$a_lbl=array();
$a_lbl['equipo']='';
$field=array();
	$field[]=array('unidad','unidad','1','label','1','','char','','cd',20,0,'',0,0,0,'','',1,1,1);	

$a_fieldsXtmp=array();

$sqlQryFields="select distinct(cd.unidad)";
$sqlQryFrom=" from ";
$sqlQryWhere=" where ";
$sqlQryOrder=" order by cd.unidad";
