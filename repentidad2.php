...
'.        "<button id=\"submit\" class=\"btn boton_act punteados b_s_sys\" type=\"button\" alt=\"Generar Reporte\" border='0' name=\"submit\" value=\"\"" . " $vars_obj><i class='fa fa-download'></i>&nbsp;Generar</button>" . '
                        ' . ("<a id=\"\" class=\"btn boton_can punteados b_s_sys\" role='button' href=\"" . $_SERVER['PHP_SELF'] . "?op=1&btnCancela=btnCancela\" ><i class='fa fa-window-close'></i>&nbsp;Cancelar</a>"
