...
$a_table=array();
$a_table['area_dep']=array('unidad');
$a_lbl=array();
$a_lbl['area_dep']='';
$field=array();
	$field[]=array('desuni','area_dep','1','label','1','','char','','u',20,0,'',0,0,0,'','',1,1,1);	
...
////////////////////////////////////////////////
$a_table=array();
$a_table['area_dep']=array('soporte_teles');
$a_lbl=array();
$a_lbl['area_dep']='';
$field=array();
	$field[]=array('area_dep','area_dep','1','label','1','','char','','p',20,0,'',0,0,0,'','',1,1,1);	

$a_fieldsXtmp=array();

$sqlQryFields="select distinct(p.area_dep)";
$sqlQryFrom=" from ";
$sqlQryWhere=" where ";
$sqlQryOrder=" order by p.area_dep";
