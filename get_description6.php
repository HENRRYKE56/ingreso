...
////////////////////////////////////////////////
$a_table=array();
$a_table['des_problema']=array('problema');
$a_lbl=array();
$a_lbl['des_problema']='';
$field=array();
	$field[]=array('tit_problema','des_problema','1','label','1','','char','','p',20,0,'',0,0,0,'','',1,1,1);	

$a_fieldsXtmp=array();

$sqlQryFields="select distinct(p.tit_problema)";
$sqlQryFrom=" from ";
$sqlQryWhere=" where ";
$sqlQryOrder=" order by p.tit_problema";
