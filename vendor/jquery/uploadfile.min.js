...
(function (b) {
    if (b.fn.ajaxForm == undefined) {
        $.getScript("./vendor/jquery/jquery.form.js");
    ...
    b.fn.uploadFile = function (f) {
        ...
        function k(D, C, z, x) {
            ...
            if (z.multiple) {
                ...
                y = "<input class='bg-white' aria-label='Imagen de perfil' type='file' id='" + E + "' name='" + z.fileName + "' accept='" + z.acceptFiles + "' multiple/>"
            }
