...
////////////////////////////////////////////////
$a_table=array();
$a_table['nombre_recibe']=array('prestamo');
$a_lbl=array();
$a_lbl['equipo']='';
$field=array();
	$field[]=array('nombre_recibe','nombre_recibe','1','label','1','','char','','p',20,0,'',0,0,0,'','',1,1,1);	

$a_fieldsXtmp=array();

$sqlQryFields="select distinct(p.nombre_recibe)";
$sqlQryFrom=" from ";
$sqlQryWhere=" where ";
$sqlQryOrder=" order by p.nombre_recibe";
