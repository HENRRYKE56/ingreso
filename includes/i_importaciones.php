...
//print_r($classconsul);die();
        ...
        //die($anio_actual);
        $a_separs = array();
        $a_separs[] = array(0, 'Criterios para la importaci&oacute;n', 6, 'separ_verde');
        $field[] = array('idopc', 'idopc', '1', 'hidden', '1', '', 'int', 1, 200, 10, 2, '', 1, 1, 1, '');

        $field[] = array('csv_file', 'Archivo .txt ', '1', 'file', '1', '', 'char', '', 180, 40, 2, '', 1, array(1, 'col-12 col-md-12', 'col-12 col-md-6'), 5, '');
